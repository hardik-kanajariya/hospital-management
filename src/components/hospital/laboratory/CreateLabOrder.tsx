    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold">Create Lab Order</h1>
                    <p className="text-muted-foreground">Create a new lab order for patient</p>
                </div>
            </div>

            <Card>
                <CardHeader>
                    <CardTitle>Create Lab Order Form</CardTitle>
                </CardHeader>
                <CardContent>
