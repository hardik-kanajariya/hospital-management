                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                                    {filteredPatients.map((patient) => (
                                        <Card
                                            key={patient.id}
                                            className={`cursor-pointer transition-all duration-200 ${formData.patient_id === patient.id
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                                    {filteredBeds.map((bed) => (
                                        <Card
                                            key={bed.id}
                                            className={`cursor-pointer transition-all duration-200 ${formData.bed_id === bed.id
                                                    ? 'ring-2 ring-blue-500 bg-blue-50'
                                                    : 'hover:shadow-md'
                                                }`}
                                ...
                                <div>
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                className={`w-full justify-start text-left font-normal ${!admissionDate && "text-muted-foreground"
                                                    }`}
                                            >
                                ...
                                <div>
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                className={`w-full justify-start text-left font-normal ${!estimatedDischargeDate && "text-muted-foreground"
                                                    }`}
                                            >
                                                <CalendarIcon className="mr-2 h-4 w-4" />
                                                {estimatedDischargeDate ? (
