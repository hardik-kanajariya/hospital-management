    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                <Button variant="outline" onClick={() => navigate(`/medical-records/${id}`)}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            {selectedPatient ? `${selectedPatient.name} (${selectedPatient.patient_id})` : 'Medical Record'}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="flex justify-end gap-3 pt-6 border-t mt-6">
                            <Button type="button" variant="outline" onClick={() => navigate(`/medical-records/${id}`)}>
                                Cancel
                            </Button>
